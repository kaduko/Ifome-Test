Feature: CRUD de veículo
  ...
  Scenario Outline: Criar um veículo com sucesso
    ...
    When eu faço uma requisição para salvar um novo veículo com o Id <id>, Renavan <renavan> , Data Modelo <dataModelo> e Placa <placa>
    ...
    Examples:
      | endpoint           | tipo   | id  | renavan       | dataModelo   | placa     | codigo |
      | "/api/v1/veiculos" | "POST" | "1" | "37759184770" | "11/12/2025" | "ZZZ9999" | "201"  |