...
public class VeiculoSteps {
    ...
    @When("eu faço uma requisição para salvar um novo veículo com o Id {string}, Renavan {string} , Data Modelo {string} e Placa {string}")
    public void euFacoUmaRequisicaoParaSalvarUmNovoVeiculoComORenavanDataModeloEPlaca(String id, String renavan, String dataModelo, String placa) {
        veiculo = new Veiculo();
